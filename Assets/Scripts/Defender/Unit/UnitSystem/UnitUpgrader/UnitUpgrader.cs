...
public partial class UnitUpgrader : MonoBehaviour
{
    ...
    public void UnitUpgradeApply(EUnitGrade _grade)
    {
        ...
        for (int i = 0; i < unitList.Count; i++)
        {
            ...
            if (unitList[i].GetComponent<UnitBase>().eUnitGrade == _grade)
            {
                Upgrade(unitList[i].GetComponent<UnitBase>(), _grade);
            }
        }
    }

    public void Upgrade(UnitBase _unit, EUnitGrade _grade)
    {
    ...
    public void MissUpgrade(int _lastUpgrade, UnitBase _unit)
    {
