...
public class UnitUI : MonoBehaviour
{
    ...
    {
        curHero = DataMng.instance.playerDataLoader.GetUnit(index);

        heroUpdate2();

        UIMng.instance.OpenPanel(heroDcPanel);
    }
    ...
    {
        if (curHero.unitUpgradeCost < DataMng.instance.playerData.gold
