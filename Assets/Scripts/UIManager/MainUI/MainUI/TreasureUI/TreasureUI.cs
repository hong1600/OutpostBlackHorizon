...
public class TreasureUI : MonoBehaviour
{
    ...
    {
        mainUI.curItems = DataMng.instance.playerDataLoader.GetItem(index);

        itemUpdate2();

        UIMng.instance.OpenPanel(itemDcPanel);
    }
    ...
    public void itemUpdate1()
    {
        ...
        {
            mainUI.curItems = DataMng.instance.playerDataLoader.GetItem(i);
    ...
    {
        if (mainUI.curItems.itemCost < DataMng.instance.playerData.gold)
        {
