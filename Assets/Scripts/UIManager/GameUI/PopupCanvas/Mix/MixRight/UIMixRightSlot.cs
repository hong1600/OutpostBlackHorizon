...
public class UIMixRightSlot : MonoBehaviour, IUIMixRightSlot
{
    ...
    private void LoadRightUnit(int _num)
    {
        ...
        for (int i = 0; i < DataMng.instance.UnitDataLoader.GetUnitByGradeData(EUnitGrade.SS)[_num].unitMixNeedUnit.Length; i++)
        {
            switch (DataMng.instance.UnitDataLoader.GetUnitByGradeData(EUnitGrade.SS)[_num].unitMixNeedUnits[i].unitGrade)
            {
                case EUnitGrade.C:
                    ...
                    mNeed0.SetUnit(DataMng.instance.UnitDataLoader.GetUnitByGradeData(EUnitGrade.SS)[_num].unitMixNeedUnits[i]);
                    sacUnitList.Add(DataMng.instance.UnitDataLoader.GetUnitByGradeData(EUnitGrade.SS)[_num].unitMixNeedUnits[i]);
                    break;
                case EUnitGrade.B:
                    ...
                    mNeed1.SetUnit(DataMng.instance.UnitDataLoader.GetUnitByGradeData(EUnitGrade.SS)[_num].unitMixNeedUnits[i]);
                    sacUnitList.Add(DataMng.instance.UnitDataLoader.GetUnitByGradeData(EUnitGrade.SS)[_num].unitMixNeedUnits[i]);
                    break;
                case EUnitGrade.A:
                    ...
                    mNeed2.SetUnit(DataMng.instance.UnitDataLoader.GetUnitByGradeData(EUnitGrade.SS)[_num].unitMixNeedUnits[i]);
                    sacUnitList.Add(DataMng.instance.UnitDataLoader.GetUnitByGradeData(EUnitGrade.SS)[_num].unitMixNeedUnits[i]);
                    break;
                case EUnitGrade.S:
                    ...
                    mNeed3.SetUnit(DataMng.instance.UnitDataLoader.GetUnitByGradeData(EUnitGrade.SS)[_num].unitMixNeedUnits[i]);
                    sacUnitList.Add(DataMng.instance.UnitDataLoader.GetUnitByGradeData(EUnitGrade.SS)[_num].unitMixNeedUnits[i]);
                    break;
            }
        }
